...
const mockData = [
    { id: "1", name: "Ielts", icon: <div className="w-3 h-3 rounded-full bg-blue-500"></div> },
    { id: "2", name: "Ielts 2", icon: <div className="w-3 h-3 rounded-full bg-blue-500"></div> },
]
...
export default function DashboardPage( ) {
    ...
    console.log(isAuthenticated, 'in dashboard');
                    ...
                    <div className="dark:bg-[#1a1a1a] bg-[#f4f4f4] text-white min-h-screen">
                        <div className="max-w-[1400px] mx-auto p-8 space-y-8">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <h1 className="text-2xl font-semibold text-gray-600">Folders</h1>
                                </div>
                                <div className="flex items-center gap-4">
